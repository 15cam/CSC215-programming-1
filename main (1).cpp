...
string greetings(string name){
    ...
    cout << "\n\nHey " << name << ", Welcome to the Hardest Riddle Game EVER!\n"
...
void playAgain(){
    ...
    if (yesNo == "Y" || yesNo == "y" || yesNo == "Yes" || yesNo == "yes"){
        // call to riddlequestions function
...
//if they want ti play again, run the main game loop again  (while)

//if no, give them thier score and end the program (while)