...

{
    ...
    cout << " \n Largest Number :" << largestnum << endl; // print largest number to console
	...
	cout << " \n Sum of all numbers in the array: " << sum << endl; // print sum to console

    // for 20 itertaions, calculate the average of all numbers int he array
	double average = static_cast<double>(sum) / 20; // calculate average by dividing sum by number of elements (20)
    cout << " \n Average of all numbers in the array: " << average << endl; // print average to console
	return 0;
